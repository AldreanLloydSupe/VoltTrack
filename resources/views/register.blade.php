    ...
    <div class="min-h-screen py-10 flex items-center justify-center bg-gradient-to-br from-[#1e3a8a] via-[#1e293b] to-[#0f172a] font-sans">
        ...
        <x-logincard class="max-w-xl">
            <div class="text-center mb-6">
                ...
                <p class="text-slate-400 text-sm mt-1">Start managing your utilities with VoltTrack today</p>
            </div>
            ...
            <form action="#" method="POST" class="space-y-4">
                ...
                <div class="grid grid-cols-2 gap-4 items-end">
                    ...
                    <div class="flex items-center space-x-4 pb-2.5 ml-1">
                        <span class="text-xs font-semibold text-slate-300 uppercase">Gender:</span>
                        <label class="inline-flex items-center text-sm text-slate-300 cursor-pointer">
                            <input type="radio" name="gender" value="male" class="mr-2 accent-blue-500"> Male
                        </label>
                        <label class="inline-flex items-center text-sm text-slate-300 cursor-pointer">
                            <input type="radio" name="gender" value="female" class="mr-2 accent-blue-500"> Female
                        </label>
                    </div>
                </div>

                <div>
                    <label class="block text-xs font-semibold text-slate-300 uppercase mb-1.5 ml-1">Password</label>
                ...
                <div>
                    <label class="block text-xs font-semibold text-slate-300 uppercase mb-1.5 ml-1">Confirm Password</label>
                ...
                <div class="flex items-center space-x-6 py-2 ml-1">
                    <span class="text-xs font-semibold text-slate-300 uppercase">User Type:</span>
                    <label class="inline-flex items-center text-sm text-slate-300 cursor-pointer">
                        <input type="radio" name="role" value="admin" class="mr-2 accent-blue-500"> Admin
                    </label>
                    <label class="inline-flex items-center text-sm text-slate-300 cursor-pointer">
                        <input type="radio" name="role" value="resident" class="mr-2 accent-blue-500"> Resident
                    </label>
                </div>

                <div class="flex items-center ml-1">
                    <input type="checkbox" required class="mr-2 rounded bg-white/20 border-none text-blue-500 focus:ring-0">
                    <p class="text-[10px] text-slate-400">I agree to the <a href="#" class="text-slate-200 hover:underline">Terms of Service</a> and <a href="#" class="text-slate-200 hover:underline">Privacy Policy</a>.</p>
                </div>
