    ...
    <div class="max-w-5xl mx-auto p-8 bg-slate-50 min-h-screen">
        <div class="mb-8 flex items-start justify-between gap-4">
            <div>
                ...
                <h1 class="text-3xl font-black text-[#F8FAFC] mt-2">Update Electricity Bill</h1>
                <p class="text-sm text-slate-400 mt-2">Edit readings, charges, and status for this electricity transaction.</p>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            >
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        <label class="block text-sm font-semibold text-slate-700 mb-2">Price Per kWh</label>
            ...
            <aside class="bg-[#001D4E] rounded-2xl p-6 text-white shadow-xl h-fit">
                ...
                <div class="space-y-4 text-sm">
                    ...
                    <div class="border-t border-white/10 pt-4">
                        ...
                        <p class="font-bold">{{ number_format((float) $bill->consumption, 2) }} kWh</p>
                    </div>
                </div>
            </aside>
        </div>
