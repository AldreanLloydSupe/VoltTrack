        ...
        <div class="flex justify-between items-center mb-10">
            <div>
                <p class="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2">
                    Resident List > Mami Jupeta > <span class="text-blue-600">Update Water Bill</span>
                </p>
            ...
            <div class="col-span-8 space-y-8">
                ...
                <div class="bg-white p-10 rounded-[40px] shadow-2xl shadow-slate-200/60 border border-slate-50">
                    ...
                    <div class="grid grid-cols-2 gap-10">
                        ...
                        <div class="space-y-3">
                            <label class="text-[11px] font-black text-slate-400 uppercase tracking-widest">Overall Total M³ Used</label>
                            <div class="relative flex items-center">
                                ...
                                <span class="absolute right-6 text-xs font-black text-slate-300 uppercase">m³</span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="grid grid-cols-2 gap-x-10 gap-y-8">
                        <div class="space-y-3">
                            ...
                            <div class="relative flex items-center">
                                ...
                                <span class="absolute right-6 text-xs font-black text-blue-600 uppercase">m³</span>
                            </div>
                        </div>
                        <div class="space-y-3">
                ...
                <div class="bg-[#001D4E] rounded-[50px] p-10 text-white shadow-2xl sticky top-12">
                    ...
                    <div class="mb-10">
                        ...
                        <div class="space-y-6 text-sm font-medium">
                            ...
                            <div class="flex justify-between items-center border-b border-white/5 pb-4">
                                <span class="text-white/50">Price per m³</span>
                                <span>₱12.50</span>
                            </div>
