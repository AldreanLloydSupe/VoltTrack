<x-layout title="Create Water Bills | VoltTrack">
    <div class="max-w-4xl mx-auto p-8 bg-slate-50 min-h-screen">
        <div class="mb-8">
            <p class="text-xs font-bold text-slate-500 uppercase tracking-wider">Billing > Water</p>
            <h1 class="text-3xl font-black text-[#001D4E] mt-2">Create Water Bill</h1>
            <p class="text-sm text-slate-500 mt-2">Create or update a Water bill for one selected resident.</p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.Create.storeNewWaterBill') }}" class="bg-white border border-slate-200 rounded-2xl p-6 space-y-6 shadow-sm">
            ...
            <div class="flex items-center gap-3 pt-2">
                ...
                <button type="submit" class="px-5 py-2.5 rounded-lg bg-[#001D4E] text-white font-semibold">Create Water Bill</button>
            </div>
        </form>
    </div>
</x-layout>
