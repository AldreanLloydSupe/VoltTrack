{{-- Renders the Create New Electricity Bill view for VoltTrack. --}}
<x-layout title="Create Electricity Bills | VoltTrack">
    <div class="max-w-4xl mx-auto p-8 bg-slate-50 min-h-screen">
        ...
        {{-- Form --}}
        <form method="POST" action="{{ route('admin.Create.storeNewElectricityBill') }}" data-instant-form class="bg-white border border-slate-200 rounded-2xl p-6 space-y-6 shadow-sm">
            @csrf
